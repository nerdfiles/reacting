   ...
   address                   PostalAddress  or                 Physical address of the item.                                                                                       
                             Text                              
   ...
   alumniOf                  EducationalOrganization  or       An organization that the person is an alumni of.                                                                    
                             Organization                      Inverse property: alumni                                                                                            
   award                     Text                              An award won by or for this item. Supersedes awards.                                                                
   birthDate                 Date                              Date of birth.                                                                                                      
   birthPlace                Place                             The place where the person was born.                                                                                
   brand                     Brand  or                         The brand(s) associated with a product or service, or the brand(s) maintained by an organization or business        
                             Organization                      person.                                                                                                             
   callSign                  Text                              A callsign, as used in broadcasting and radio communications to identify people, radio and TV stations, or          
                                                               vehicles.                                                                                                           
   children                  Person                            A child of the person.                                                                                              
   colleague                 Person  or                        A colleague of the person. Supersedes colleagues.                                                                   
                             URL                               
   ...
   funder                    Organization  or                  A person or organization that supports (sponsors) something through some kind of financial contribution.            
                             Person                            
   funding                   Grant                             A Grant that directly or indirectly provide funding or sponsorship for this item. See also ownershipFundingInfo.    
                             ...
                             GenderType  or                    https://schema.org/Male and https://schema.org/Female may be used, text strings are also acceptable for people who  
   gender                    Text                              do not identify as a binary gender. The gender property can also be used in an extended sense to cover e.g. the     
   ...
   globalLocationNumber      Text                              respective organization, person, or place. The GLN is a 13-digit number used to identify parties and physical       
                                                               locations.                                                                                                          
   ...
   height                    Distance  or                      The height of the item.                                                                                             
                             QuantitativeValue                 
   homeLocation              ContactPoint  or                  A contact location for a person's residence.                                                                        
                             Place                             
   ...
   interactionStatistic      InteractionCounter                The number of interactions for the CreativeWork using the WebSite or SoftwareApplication. The most specific child   
                                                               type of InteractionCounter should be used. Supersedes interactionCount.                                             
   isicV4                    Text                              The International Standard of Industrial Classification of All Economic Activities (ISIC), Revision 4 code for a    
                                                               particular organization, business person, or place.                                                                 
   jobTitle                  DefinedTerm  or                   The job title of the person (for example, Financial Manager).                                                       
                             Text                              
   knows                     Person                            The most generic bi-directional social/work relation.                                                               
                             Text  or                          Of a Person, and less typically of an Organization, to indicate a topic that is known about - suggesting possible   
   knowsAbout                Thing  or                         expertise but not implying it. We do not distinguish skill levels here, or relate this to educational content,      
                             URL                               events, objectives or JobPosting descriptions.                                                                      
   knowsLanguage             Language  or                      Of a Person, and less typically of an Organization, to indicate a known language. We do not distinguish skill       
                             Text                              levels or reading/writing/speaking/signing here. Use language codes from the IETF BCP 47 standard.                  
   makesOffer                Offer                             A pointer to products or services offered by the organization or person.                                            
                                                               Inverse property: offeredBy                                                                                         
   memberOf                  Organization  or                  An Organization (or ProgramMembership) to which this Person or Organization belongs.                                
                             ProgramMembership                 Inverse property: member                                                                                            
   ...
   netWorth                  MonetaryAmount  or                The total financial value of the person as calculated by subtracting assets from liabilities.                       
                             PriceSpecification                
   owns                      OwnershipInfo  or                 Products owned by the organization or person.                                                                       
                             Product                           
   ...
   performerIn               Event                             Event that this person is a performer or participant in.                                                            
                                                               The publishingPrinciples property indicates (typically via URL) a document describing the editorial principles of   
                                                               an Organization (or individual e.g. a Person writing a blog) that relate to their activities as a publisher, e.g.   
                             CreativeWork  or                  ethics or diversity policies. When applied to a CreativeWork (e.g. NewsArticle) the principles are those of the     
   publishingPrinciples      URL                               party primarily responsible for the creation of the CreativeWork.                                                   
                                                                                                                                                                                   
                                                               While such policies are most typically expressed in natural language, sometimes related information (e.g.           
                                                               indicating a funder) can be expressed using schema.org terminology.                                                 
   ...
   sponsor                   Organization  or                  A person or organization that supports a thing through a pledge, promise, or financial contribution. e.g. a sponsor 
                             Person                            of a Medical Study or a corporate sponsor of an event.                                                              
   ...
   workLocation              ContactPoint  or                  A contact location for a person's place of work.                                                                    
                             Place                             
   ...
   additionalType            URL                               microdata syntax. This is a relationship between something and a class that the thing is in. In RDFa syntax, it is  
                                                               better to use the native RDFa syntax - the 'typeof' attribute - for multiple types. Schema.org tools may have only  
   ...
   disambiguatingDescription Text                              Information from other properties (in particular, name) may be necessary for the description to be useful for       
                                                               disambiguation.                                                                                                     
                             PropertyValue  or                 The identifier property represents any kind of identifier for any kind of Thing, such as ISBNs, GTIN codes, UUIDs   
   identifier                Text  or                          etc. Schema.org provides dedicated properties for representing many of these, either as textual strings or as URL   
                             URL                               (URI) links. See background notes for more details.                                                                 
   image                     ImageObject  or                   An image of the item. This can be a URL or a fully described ImageObject.                                           
                             URL                               
                             CreativeWork  or                  Indicates a page (or other CreativeWork) for which this thing is the main entity being described. See background    
   mainEntityOfPage          URL                               notes for details.                                                                                                  
                                                               Inverse property: mainEntity                                                                                        
   name                      Text                              The name of the item.                                                                                               
   potentialAction           Action                            Indicates a potential Action, which describes an idealized action in which this thing would play an 'object' role.  
   sameAs                    URL                               URL of a reference Web page that unambiguously indicates the item's identity. E.g. the URL of the item's Wikipedia  
                                                               page, Wikidata entry, or official website.                                                                          
   subjectOf                 CreativeWork  or                  A CreativeWork or Event about this Thing.                                                                           
                             Event                             Inverse property: about                                                                                             
   ...
   acquiredFrom           OwnershipInfo                      The organization or person from which the product was acquired.                                                       
                          ...
                          Event  or                          
                          Movie  or                          
   actor                  MovieSeries  or                    An actor, e.g. in tv, radio, movie, video games etc., or in an event. Actors can be associated with individual items
                          PodcastSeries  or                  or with a series, episode, clip.
                          RadioSeries  or                    
                          TVSeries  or                       
                          VideoGame  or                      
                          VideoGameSeries  or                
                          ...
                          Episode  or                                                                                                                                              
                          Movie  or                          
                          MovieSeries  or                    An actor, e.g. in tv, radio, movie, video games etc. Actors can be associated with individual items or with a series,
   actors                 RadioSeries  or                    episode, clip.
                          TVSeries  or                       
                          VideoGame  or                      
                          VideoGameSeries  or                
                          VideoObject                        
   agent                  Action                             The direct performer or driver of the action (animate or inanimate). e.g. John wrote a book.                          
   alumni                 EducationalOrganization  or        Alumni of an organization.                                                                                            
                          Organization                       
                          ComicIssue  or                     The primary artist for a work in a medium other than pencils or digital line art--for example, if the primary artwork 
   artist                 ComicStory  or                     is done in watercolors or digital paints.                                                                             
                          VisualArtwork                      
   ...
   attendees              Event                              A person attending the event.                                                                                         
   author                 CreativeWork  or                   The author of this content or rating. Please note that author is special in that HTML 5 provides a special mechanism  
                          Rating                             for indicating authorship via the rel tag. That is equivalent to this and may be used interchangeably.                
   ...
   bookingAgent           Reservation                        'bookingAgent' is an out-dated term indicating a 'broker' that serves as a booking agent.                             
   borrower               LendAction                         A sub property of participant. The person that borrows the object being lent.                                         
                          Invoice  or                        An entity that arranges for an exchange between a buyer and a seller. In most cases a broker never acquires or        
   broker                 Order  or                          releases ownership of a product or service involved in an exchange. If it is not clear whether an entity is a broker, 
                          Reservation  or                    seller, or buyer, the latter two terms are preferred.                                                                 
                          Service                            
   buyer                  SellAction                         A sub property of participant. The participant/person/organization that bought the object.                            
   byArtist               MusicAlbum  or                     The artist that performed this album or recording.                                                                    
                          MusicRecording                     
   ...
   children               Person                             A child of the person.                                                                                                
   claimInterpreter       Claim                              For a Claim interpreted from MediaObject content sed to indicate a claim contained, implied or refined from the       
   ...
   colleagues             Person                             A colleague of the person.                                                                                            
                          ComicIssue  or                                                                                                                                           
   colorist               ComicStory  or                     The individual who adds color to inked drawings.
                          VisualArtwork                      
   competitor             SportsEvent                        A competitor in a sports event.                                                                                       
   composer               Event  or                          The person or organization who wrote a composition, or who is the composer of a work performed at some event.         
                          MusicComposition                   
   contributor            CreativeWork  or                   A secondary contributor to the CreativeWork or Event.                                                                 
                          Event                              
   copyrightHolder        CreativeWork                       The party holding the legal copyright to the CreativeWork.                                                            
   creator                CreativeWork  or                   The creator/author of this CreativeWork. This is the same as the Author property for CreativeWork.                    
                          UserComments                       
   creditedTo             MusicRelease                       The group the release is credited to if different than the byArtist. For example, Red and Blue is credited to         
                                                             "Stefani Germanotta Band", but by Lady Gaga.                                                                          
   customer               Invoice  or                        Party placing the order or paying the invoice.                                                                        
                          Order                              
                          Clip  or                                                                                                                                                 
                          CreativeWorkSeason  or                                                                                                                                   
                          Episode  or                        
                          Event  or                          
                          Movie  or                          A director of e.g. tv, radio, movie, video gaming etc. content, or of an event. Directors can be associated with
   director               MovieSeries  or                    individual items or with a series, episode, clip.
                          RadioSeries  or                    
                          TVSeries  or                       
                          VideoGame  or                      
                          VideoGameSeries  or                
                          ...
                          Episode  or                                                                                                                                              
                          Movie  or                          
                          MovieSeries  or                    A director of e.g. tv, radio, movie, video games etc. content. Directors can be associated with individual items or
   directors              RadioSeries  or                    with a series, episode, clip.
                          TVSeries  or                       
                          VideoGame  or                      
                          VideoGameSeries  or                
                          VideoObject                        
   ...
   employees              Organization                       People working for this organization.                                                                                 
   ...
   founders               Organization                       A person who founded this organization.                                                                               
   fundedItem             Grant                              Indicates something directly or indirectly funded or sponsored through a Grant. See also ownershipFundingInfo.        
                          CreativeWork  or                                                                                                                                         
                          Event  or                          
   funder                 Grant  or                          A person or organization that supports (sponsors) something through some kind of financial contribution.
                          MonetaryGrant  or                  
                          Organization  or                   
                          Person                             
   ...
   illustrator            Book                               The illustrator of the book.                                                                                          
                          ComicIssue  or                                                                                                                                           
   inker                  ComicStory  or                     The individual who traces over the pencil drawings in ink after pencils are complete.
                          VisualArtwork                      
   ...
   landlord               RentAction                         A sub property of participant. The owner of the real estate property.                                                 
                                                             The person or organization that originally passed or made the law : typically parliament (for primary legislation) or 
   legislationPassedBy    Legislation                        government (for secondary legislation). This indicates the "legal author" of the law, as opposed to its physical      
                                                             author.                                                                                                               
                                                             An individual or organization that has some kind of responsibility for the legislation. Typically the ministry who    
   legislationResponsible Legislation                        is/was in charge of elaborating the legislation, or the adressee for potential questions about the legislation once   
                                                             it is published.                                                                                                      
   lender                 BorrowAction                       A sub property of participant. The person that lends the object being borrowed.                                       
                          ComicIssue  or                                                                                                                                           
   letterer               ComicStory  or                     The individual who adds lettering, including speech balloons and sound effects, to artwork.
                          VisualArtwork                      
   ...
   lyricist               MusicComposition                   The person who wrote the words.                                                                                       
                                                             A maintainer of a Dataset, software package (SoftwareApplication), or other Project. A maintainer is a Person or      
                                                             Organization that manages contributions to, and/or publication of, some (typically complex) artifact. It is common    
                                                             for distributions of software and data to be based on "upstream" sources. When maintainer is applied to a specific    
   maintainer             CreativeWork                       version of something e.g. a particular version or packaging of a Dataset, it is always possible that the upstream     
                                                             source has a different maintainer. The isBasedOn property can be used to indicate such relationships between datasets 
                                                             to make the different maintenance roles clear. Similarly in the case of software, a package may have dedicated        
                                                             maintainers working on integration into software distributions such as Ubuntu, as well as upstream maintainers of the 
                                                             underlying work.                                                                                                      
   member                 Organization  or                   A member of an Organization or a ProgramMembership. Organizations can be members of organizations; ProgramMembership  
                          ProgramMembership                  is typically for individuals.                                                                                         
   members                Organization  or                   A member of this organization.                                                                                        
                          ProgramMembership                  
   merchant               Order                              'merchant' is an out-dated term for 'seller'.                                                                         
                          ...
                          Movie  or                          
                          MovieSeries  or                    
   musicBy                RadioSeries  or                    The composer of the soundtrack.
                          TVSeries  or                       
                          VideoGame  or                      
                          VideoGameSeries  or                
                          VideoObject                        
   musicGroupMember       MusicGroup                         A member of a music group—for example, John, Paul, George, or Ringo.                                                  
   ...
   participant            Action                             Other co-agents that participated in the action indirectly. e.g. John wrote a book with Steve.                        
                          ComicIssue  or                                                                                                                                           
   penciler               ComicStory  or                     The individual who draws the primary narrative artwork.
                          VisualArtwork                      
   ...
   provider               Invoice  or                        The service provider, service operator, or service performer; the goods producer. Another party (a seller) may offer
                          ParcelDelivery  or                 those services or goods on behalf of the provider. A provider may also serve as the seller.
                          Reservation  or                    
                          Service  or                        
                          Trip                               
   ...
   readBy                 Audiobook                          A person who reads (performs) the audiobook.                                                                          
                          ...
                          DonateAction  or                   
                          GiveAction  or                     
   recipient              Message  or                        A sub property of participant. The participant who is at the receiving end of the action.
                          PayAction  or                      
                          ReturnAction  or                   
                          SendAction  or                     
                          TipAction                          
   ...
   reviewedBy             WebPage                            People or organizations that have reviewed the content on this web page for accuracy and/or completeness.             
                                                             Indicates the party responsible for generating and publishing the current structured data markup, typically in cases  
   sdPublisher            CreativeWork                       where the structured data is derived automatically from existing published content but published on a different site. 
                                                             For example, student projects and open data initiatives often re-publish existing content with more explicitly        
                                                             structured metadata. The sdPublisher property helps make such practices more explicit.                                
                          BuyAction  or                                                                                                                                            
                          Demand  or                         
   seller                 Flight  or                         An entity which offers (sells / leases / lends / loans) the services / goods. A seller may also be a provider.
                          Offer  or                          
                          Order                              
   sender                 Message  or                        A sub property of participant. The participant who is at the sending end of the action.                               
                          ReceiveAction                      
   sibling                Person                             A sibling of the person.                                                                                              
   siblings               Person                             A sibling of the person.                                                                                              
   spokenByCharacter      Quotation                          The (e.g. fictional) character, Person or Organization to whom the quotation is attributed within the containing      
                                                             CreativeWork.                                                                                                         
                          CreativeWork  or                                                                                                                                         
                          Event  or                                                                                                                                                
   sponsor                Grant  or                          A person or organization that supports a thing through a pledge, promise, or financial contribution. e.g. a sponsor
                          MedicalStudy  or                   of a Medical Study or a corporate sponsor of an event.
                          Organization  or                   
                          Person                             
   spouse                 Person                             The person's spouse.                                                                                                  
   toRecipient            Message                            A sub property of recipient. The recipient who was directly sent the message.                                         
   translator             CreativeWork  or                   Organization or person who adapts a creative work to different languages, regional differences and technical          
                          Event                              requirements of a target market, or that translates during some event.                                                
   underName              Reservation  or                    The person or organization the reservation or ticket is for.                                                          
                          Ticket                             
   vendor                 BuyAction                          'vendor' is an earlier term for 'seller'.                                                                             
   ...
   This class contains derivatives of IPTC rNews properties. rNews is a data model of publishing metadata with serializations currently available for RDFa as well as HTML5
   Microdata. More information about the IPTC and rNews can be found at rnews.org.
